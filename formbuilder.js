    ...
    Formbuilder.views = {
      ...
      main: Backbone.View.extend({
        ...
        applyEasyWizard: function() {
          (function(_this) {
            return (function(field_view, cnt, fieldViews, add_break_to_next, wizard_view, wiz_cnt, prev_btn_text, next_btn_text, showSubmit, sub_frag) {
          ...
          })(this)(null, 1, this.fieldViews, false, null, 1, 'Back', 'Next', this.options.showSubmit, document.createDocumentFragment());
          return this;
        },
...
(function() {
  Formbuilder.registerField('address', {
    ...
    print: "<table class=\"innerTbl\">\n  <tbody>\n    <tr>\n      <td>\n        <label>Street Address</label>\n      </td>\n      <td>\n        <label>Suburb/City</label>\n      </td>\n      <td>\n        <label>State / Province / Region</label>\n      </td>\n      <td>\n        <label>Postal/Zip Code</label>\n      </td>\n      <td>\n        <label>Country</label>\n      </td>\n    </tr>\n    <tr id=\"values\">\n      <td>\n        <label id=\"address\"></label>\n      </td>\n      <td>\n        <label id=\"suburb\"></label>\n      </td>\n      <td>\n        <label id=\"state\"></label>\n      </td>\n      <td>\n        <label id=\"zipcode\"></label>\n      </td>\n      <td>\n        <select id=\"file_<%=rf.getCid()%>\" data-country=\"<%= rf.get(Formbuilder.options.mappings.DEFAULT_COUNTRY)%>\" class='span7 bfh-selectbox bfh-countries'></select>\n      </td>\n    </tr>\n  </tbody>\n</table>\n<script>\n  $(function() {\n    $(\"#file_<%= rf.getCid() %>\").bfhcount();\n  });\n</script>",
...
(function() {
  Formbuilder.registerField('ci-hierarchy', {
    ...
    setValForPrint: function(fd_view) {
      ...
      })(this)(null, null, null, null, null, '', '', '', null, null, null, Formbuilder.options.COMPANY_HIERARCHY);
    },
