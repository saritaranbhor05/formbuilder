...
(function() {
  Formbuilder.registerField('gmap', {
    ...
    addRequiredConditions: function() {
      var close_button, disabled, hide_class, is_locate_me;
      is_locate_me = Formbuilder.options.FIELD_CONFIGS['gmap'] === 'locate_me';
      disabled = (is_locate_me ? "disabled" : "");
      hide_class = (is_locate_me ? "hide" : "");
      close_button = (is_locate_me ? "<button type='button' class='btn btn-default' data-dismiss='modal'>Close</button>" : "");
